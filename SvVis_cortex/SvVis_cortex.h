...
osStatus_t SvVis3_send_I32(SvVis3_t*, SvVis3_channel_t channel, int32_t data, uint32_t timeout);
osStatus_t SvVis3_send_float(SvVis3_t*, SvVis3_channel_t channel, float data, uint32_t timeout);
