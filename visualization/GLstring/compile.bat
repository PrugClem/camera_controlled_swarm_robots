...
ar -s -r lib_GLstring.a obj/character_class.o obj/font_class.o obj/string_class.o ../../library/glew-2.1.0/lib/Release/Win32/glew32.lib ../../library/glew-2.1.0/lib/Release/Win32/glew32s.lib
