...
*
* @version release 1.1.0 - not ready yet
* @copyright (C) Michael Reim, distribution without my consent is prohibited.
*
* Update Infos for version 1.1.0:
* Changes:
*   - removed get_original_tex_coords, now you can get them via GLSTR_IGNORE_X and GLSTR_IGNORE_Y
*   - removed the last 3 big constructors and set methods
*   - added second set_color method without index, it colors the whole string with one call
*   - added update method which only updates the drawing data, generate instead does transformation calculation and updates the drawing data
*
* Bugfixes:
*   - push_front and push_back does now consider alpha value
*
* General:
*   - better performance
*   - less memory usage
