...
class TextInputActionEvent : public ElementActionEvent
{
protected:
    virtual bool event_trigger(void)
    {
        if(this->event_queue.size() > 0)
        {
            if(this->event_queue.at(0).element->get_type() == GUI::Element::Type::TEXT_INPUT)
                return true;
        }
        return false;
    }
...
public:
    GUI::Element& get_element(void) = delete;
    GUI::TextInput& get_text_input(void)   {return *((GUI::TextInput*)this->event_queue.at(0).element);}
};

class TextInputEditEvent : public TextInputActionEvent
{
protected:
    virtual bool event_trigger(void)
    {
        if(this->event_queue.size() > 0)
        {
            ...
            (
                ...
                (
                    action == GUI::TextInputAction::TEXT_WRITE ||
                    action == GUI::TextInputAction::TEXT_DELETE
                )
            )
            {
                return true;
...
class TextInputEnterEvent : public TextInputActionEvent
{
protected:
    virtual bool event_trigger(void)
    {
        if(this->event_queue.size() > 0)
        {
            ...
            (
                this->event_queue.at(0).element->get_type() == GUI::Element::Type::TEXT_INPUT &&
                (
                    action == GUI::TextInputAction::TEXT_ENTER
                )
            )
            {
                return true;
...
class TextInputActivateEvent : public TextInputActionEvent
{
protected:
    virtual bool event_trigger(void)
    {
        if(this->event_queue.size() > 0)
        {
            ...
            (
                this->event_queue.at(0).element->get_type() == GUI::Element::Type::TEXT_INPUT &&
                (
                    action == GUI::TextInputAction::TEXT_BOX_ACTIVATE ||
                    action == GUI::TextInputAction::TEXT_BOX_DEACTIVATE
                )
            )
            {
                return true;
